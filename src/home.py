...
<h2 class="c">メニュー（横長box1タイプ）</h2>

<h3 class="c">transformの指定なし</h3>

	<div class="box1">
	<figure><img src="images/sample1.jpg" alt="メニュー名"></figure>
	<h4>メニュー名　XXX円</h4>
	<p>&lt;div class=&quot;box1&quot;&gt;<br>
	とするとこのボックス(アニメーションなし)になります。<br>
	左上の「人気」のテキストは直接html側で変更できます。色や配置などはcssフォルダのstyle.cssの「.mark」で調整できます。900px以下の設定もあるので注意して下さい。</p>
...
<h3 class="c">transform1サンプル</h3>

	<div class="box1 transform1">
	<figure><img src="images/sample1.jpg" alt="メニュー名"></figure>
	<h4>メニュー名　XXX円</h4>
	<p>&lt;div class=&quot;box1 transform1&quot;&gt;<br>
	とするとこのボックスの動作になります。<br>
	左上の「人気」のテキストは直接html側で変更できます。色や配置などはcssフォルダのstyle.cssの「.mark」で調整できます。900px以下の設定もあるので注意して下さい。</p>
	<span class="mark">人気</span>
	</div>
...
<h3 class="c">transform2サンプル</h3>

	<div class="box1 transform2">
	<figure><img src="images/sample1.jpg" alt="メニュー名"></figure>
	<h4>メニュー名　XXX円</h4>
	<p>&lt;div class=&quot;box1 transform2&quot;&gt;<br>
	とするとこのボックスの動作になります。<br>
	左上の「人気」のテキストは直接html側で変更できます。色や配置などはcssフォルダのstyle.cssの「.mark」で調整できます。900px以下の設定もあるので注意して下さい。</p>
	<span class="mark">人気</span>
	</div>
...
<h3 class="c">upサンプル</h3>

	<div class="box1 up">
	<figure><img src="images/sample1.jpg" alt="メニュー名"></figure>
	<h4>メニュー名　XXX円</h4>
	<p>&lt;div class=&quot;box1 up&quot;&gt;<br>
	とするとこのボックスの動作になります。<br>
	左上の「人気」のテキストは直接html側で変更できます。色や配置などはcssフォルダのstyle.cssの「.mark」で調整できます。900px以下の設定もあるので注意して下さい。</p>
	<span class="mark">人気</span>
	</div>
...
<h3 class="c">leftサンプル</h3>

	<div class="box1 left">
	<figure><img src="images/sample1.jpg" alt="メニュー名"></figure>
	<h4>メニュー名　XXX円</h4>
	<p>&lt;div class=&quot;box1 left&quot;&gt;<br>
	とするとこのボックスの動作になります。<br>
	左上の「人気」のテキストは直接html側で変更できます。色や配置などはcssフォルダのstyle.cssの「.mark」で調整できます。900px以下の設定もあるので注意して下さい。</p>
	<span class="mark">人気</span>
	</div>
...
<h3 class="c">rightサンプル</h3>

	<div class="box1 right">
	<figure><img src="images/sample1.jpg" alt="メニュー名"></figure>
	<h4>メニュー名　XXX円</h4>
	<p>&lt;div class=&quot;box1 right&quot;&gt;<br>
	とするとこのボックスの動作になります。<br>
	左上の「人気」のテキストは直接html側で変更できます。色や配置などはcssフォルダのstyle.cssの「.mark」で調整できます。900px以下の設定もあるので注意して下さい。</p>
	<span class="mark">人気</span>
	</div>
...
<h2 class="c">メニュー（コンパクトbox2タイプ）</h2>
...
<h3 class="c">画像のみの指定などもできます</h3>

	<div class="box2">
	<figure class="transform1"><img src="images/sample1.jpg" alt="メニュー名"></figure>
	<h4>メニュー名　XXX円</h4>
	<p>タイトルも説明文も短めにして下さい。長いと途中で切れます。タイトルも説明文も短めにして下さい。長いと途中で切れます。タイトルも説明文も短めにして下さい。長いと途中で切れます。</p>
	<span class="mark">人気</span>
	</div>
...
<h2 class="c">メニュー（テキストタイプ）</h2>

<div class="half">

<dl class="menu">
<dt>メニュータイトルをここに入れます。</dt>
	<dd>メニュー名をここに入れます。<span class="price">XXX円</span></dd>
	<dd>メニュー名をここに入れます。<span class="price">XXX円</span></dd>
	<dd>メニュー名をここに入れます。<span class="price">XXX円</span></dd>
<dt>メニュータイトルをここに入れます。</dt>
	<dd>メニュー名をここに入れます。<span class="price">XXX円</span></dd>
...
<dl class="menu">
<dt>メニュータイトルをここに入れます。</dt>
	<dd>メニュー名。<span class="price">XXX円</span></dd>
	<dd>メニュー名。<span class="price">XXX円</span></dd>
<dt>メニュータイトルをここに入れます。</dt>
	<dd>メニュー名。<span class="price">XXX円</span></dd>
	<dd>メニュー名。<span class="price">XXX円</span></dd>
...
<h2>オリジナルのアニメーションを作りたい場合は</h2>
<p>cssフォルダのinview.cssに、cssで動くアニメーションタグを追加します。<br>
css冒頭の「共通設定」の２箇所にも追加するのを忘れないようご注意下さい。</p>
<p>スタイルを追加したら、jsフォルダのjquery.invie_set.jsにタグを追加して下さい。<br>
既存のタグをコピペして、スタイル名を２箇所入れ替えればOKです。</p>

<h3>transformのアニメーションが動作しない場合</h3>
<p>htmlの下部に、<br>
<span class="color1">&lt;!--パララックス用ファイル読み込み--&gt;<br>
&lt;script src=&quot;https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js&quot;&gt;&lt;/script&gt;<br>
&lt;script src=&quot;https://cdnjs.cloudflare.com/ajax/libs/protonet-jquery.inview/1.1.2/jquery.inview.min.js&quot;&gt;&lt;/script&gt;<br>
&lt;script src=&quot;js/jquery.inview_set.js&quot;&gt;&lt;/script&gt;</span><br>
のタグがあるか確認して下さい。</p>
<p>httpsから始まるurlは将来リンク切れを起こす可能性もあります。その際は改めて「jQuery CDN」などでネット検索し、新しいurlに置き換えて下さい。</p>
